...
Y1 = [7.3 + 8.8*X1[i] + 1.3*X2[i] + 9.1*X3[i] + 2.1*X8[i] + 0.1*X9[i] + 2.1*X10[i] + 4.6*X12[i] + 0.5*X13[i] + 4.1*X23[i] + 7.2*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y2 = [7.3 + 8.8*X1[i] + 1.3*X2[i] + 9.1*X3[i] + 2.1*X8[i] + 0.1*X9[i] + 2.1*X10[i] + 4.6*X12[i] + 0.5*X13[i] + 4.1*X23[i] + 7.2*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y3 = [7.3 + 8.8*X1[i] + 1.3*X2[i] + 9.1*X3[i] + 2.1*X8[i] + 0.1*X9[i] + 2.1*X10[i] + 4.6*X12[i] + 0.5*X13[i] + 4.1*X23[i] + 7.2*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
for i in range(15):
